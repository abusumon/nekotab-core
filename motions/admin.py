...
class MotionAdmin(NekoTabModelAdminFieldsMixin, ModelAdmin):
    list_display = ('reference', 'text')
    list_filter = ('rounds',)


@admin.register(DebateTeamMotionPreference)
class DebateTeamMotionPreferenceAdmin(NekoTabModelAdminFieldsMixin, ModelAdmin):
...
class RoundMotionAdmin(NekoTabModelAdminFieldsMixin, ModelAdmin):
