...
DATABASES = {
    'default': {
        ...
        'NAME'        : 'nekotab',  # put your PostgreSQL database's name in here
        'USER'        : 'nekotab',  # put your PostgreSQL login role's user name in here
        'PASSWORD'    : '01324202591@Abs',  # put your PostgreSQL login role's password in here
        'HOST'        : 'localhost',
        'PORT'        : '5432',
        'CONN_MAX_AGE': None,
    }
