...
urlpatterns = [
    ...
    path('create/requests/',
        tournaments.views.TournamentCreationRequestListView.as_view(),
        name='tournament-create-requests'),
    path('create/verify/<uuid:request_id>/',
        tournaments.views.TournamentOTPVerifyView.as_view(),
        name='tournament-create-verify'),
    path('load-demo/',
