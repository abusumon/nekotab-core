...
class IETournamentStartForm(ModelForm):
    """Simplified tournament creation form for Individual Events (IE).
    IE tournaments don't need break rounds or break sizes."""
